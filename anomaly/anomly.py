...
class expAvgDetector(Detector):
	...
	def generate_anom_data(self, csv_name=None):
...
class BitmapDetector(Detector):
	...
	def _compute_anom_score(self, lag_window_sax, cur_sax, chunk_size):
		...
		return 1-float(freq[cur_sax])/float(freq['total'])
...
if __name__=="__main__":
	# bitmapdtc = BitmapDetector()
	# bitmapdtc.read_data('GC.commit0.csv')
	# bitmapdtc.detect_anom_full_range()
	# print bitmapdtc.get_anom_data()
