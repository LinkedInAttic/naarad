...
class TestCorrelator(unittest.TestCase):
  ...
  def test_algorithm(self):
    ...
    correlator = Correlator(self.s1, self.s2, 'CrossCorrelation')
  ...
  def test_algorithm_params(self):
    ...
    """
    self.assertRaises(exceptions.InvalidDataFormat, lambda: Correlator(self.s1, self.s2, 'CrossCorrelation', 1))
    correlator = Correlator(self.s1, self.s2, 'CrossCorrelation', {'max_shift_seconds': 180})
    self.assertEqual(self.correlator2.get_correlation_result().coefficient, correlator.get_correlation_result().coefficient)
  ...
  def test_maximal_shift_seconds(self):
    ...
    """
    correlator = Correlator(self.s1, self.s2, 'CrossCorrelation', {'max_shift_seconds': 0})
...
class TestAnomalyDetector(unittest.TestCase):
  ...
  def test_algorithm_ExpAvgDetector(self):
    ...
    Test if optional parameter algorithm works as expected.
    """
    detector = AnomalyDetector(self.s1, algorithm='ExpAvgDetector')
  ...
  def test_algorithm(self):
    ...
    """
    self.assertRaises(exceptions.AlgorithmNotFound, lambda: AnomalyDetector(self.s1, algorithm='NotValidAlgorithm'))

  def test_algorithm_params(self):
    """
    Test if optional parameter algorithm_params works as expected.
    """
    self.assertRaises(exceptions.InvalidDataFormat, lambda: AnomalyDetector(self.s1, algorithm='ExpAvgDetector', algorithm_params='0'))
    detector = AnomalyDetector(self.s1, algorithm="ExpAvgDetector", algorithm_params={'smoothing_factor': 0.3})
  ...
  def test_anomaly_threshold(self):
    ...
    """
    detector = AnomalyDetector(self.s1, algorithm='ExpAvgDetector', algorithm_params={'score_percentile_threshold': 0.8})
