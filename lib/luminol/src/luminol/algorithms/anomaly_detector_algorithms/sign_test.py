...
class SignTest(AnomalyDetectorAlgorithm):
  ...
  def __init__(self, time_series, baseline_time_series,
    ...
    :param scan_window: window size to evaluate for anomalies
  ...
  def _rolling_sign_test(x, y, k=24, alpha=0.05, shift=0.0, conf=0.01, gap=0):
    ...
    :param k how many values to compare default is 24
    :param alpha scaling for y in precents 0.5 = 5% increase
    :param T threshold default is 17 which means we want 75% of total
    """
